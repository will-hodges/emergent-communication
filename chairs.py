...
class ChairsInContext(data.Dataset):
    ...
    def __init__(
        ...
        self.dia_index = self.w2i[self.dia_token]
    ...
    def build_vocab(self, texts):
        ...
        i2w = dict()
        w2c = OrderedCounter()
        special_tokens = [PAD_TOKEN, SOS_TOKEN, EOS_TOKEN, UNK_TOKEN, DIA_TOKEN]
    ...
    def __getitem__(self, index):
        ...
        return torch.cat((chair_a_pt.unsqueeze(0), chair_b_pt.unsqueeze(0), chair_c_pt.unsqueeze(0)),0), label, text_seq
